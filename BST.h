...
struct BST {
		...
		//b
		bool deepestNodes(); //find and print all the nodes at the deepest level
		void printDeepestNodes(BTNode*, int);
		int getHeight(BTNode*); //get height of the left and right subtrees
		...
		//f
		bool printPath();
		void printExternal(BTNode*, string);
};
